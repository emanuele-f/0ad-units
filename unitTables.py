...
Civs = ["athen", "mace", "spart", "cart", "rome", "pers", "maur", "brit", "gaul", "ptol", "iber"]
#Civs = ["rome","pers"]
...
basePath = os.path.realpath(__file__).replace("unitTables.py","") + "./templates/"
...
for Civ in Civs:
	...
	for building in CivBuildings:
		...
		for UnitFile in TrainableUnits:
			UnitFile = UnitFile.replace("{civ}", Civ)
			breakIt = False
